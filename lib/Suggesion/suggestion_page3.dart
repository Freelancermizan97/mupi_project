...
class SuggestionPage3 extends StatefulWidget {
  const SuggestionPage3({Key? key}) : super(key: key);

  @override
  State<SuggestionPage3> createState() => _SuggestionPage3State();
}

class _SuggestionPage3State extends State<SuggestionPage3> {
  @override
