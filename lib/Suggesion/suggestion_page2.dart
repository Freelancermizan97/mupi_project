...
class SuggestionPage2 extends StatefulWidget {
  const SuggestionPage2({Key? key}) : super(key: key);

  @override
  State<SuggestionPage2> createState() => _SuggestionPage2State();
}

class _SuggestionPage2State extends State<SuggestionPage2> {
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  InkWell(
                    onTap: (){
                      Navigator.push(context, MaterialPageRoute(builder: (context)=>SuggestionPage3()));
                    },
