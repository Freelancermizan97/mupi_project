...
class NoticePage4 extends StatefulWidget {
  const NoticePage4({Key? key}) : super(key: key);

  @override
  State<NoticePage4> createState() => _NoticePage4State();
}

class _NoticePage4State extends State<NoticePage4> {
